            ...
            <div id="page">
               <div class="row-fluid">
                  <div class="span12">
                     ...
                     <div class="widget">
                        ...
                        <div class="widget-body form">
                         ...
                         <?php echo form_open('abbonamenti/abb_edit/'.$abbonamenti_item['slug') ?>
				...
				<div class="control-group">
				 ...
				 <div class="controls">
				    <input class="input-small date-picker" size="16" type="text" value=""<?php echo $abbonamenti_item['date_created']?>"" name="data_acquisto" data-date-format="yyyy-mm-dd"/>
				 </div>
				</div>			
