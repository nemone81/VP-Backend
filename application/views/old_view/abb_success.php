<div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
	...
	<div class="widget">
		...
		<div class="widget-body">
            ...
            <button class="btn btn-info" onclick="location.href='<?php  echo base_url('index.php/abbonamenti/create/'.$soci_item['id']) ?>'"><i class="icon-plus icon-white"></i> Inserici un nuovo abbonamentio</button><br><br><p style="color:grey">            </div>	
        </div>
   </div>	
</div>	
